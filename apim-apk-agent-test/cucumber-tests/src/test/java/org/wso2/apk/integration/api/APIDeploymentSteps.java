...
public class APIDeploymentSteps {
    ...
    public void iHaveTheOASURL(String OASURL) throws IOException {
        OASURL = OASURL;
    }
    ...
    @When("make the import API Deployment request")
    public void make_import_api_deployment_request() throws Exception {
        ...
        MultipartEntityBuilder builder = MultipartEntityBuilder.create()
                ...
                .addTextBody("additionalProperties", payloadFile.toString(), ContentType.APPLICATION_JSON);
