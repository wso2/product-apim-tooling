...
func init() {
	...
	ImportAPICmd.Flags().StringVarP(&apiName, "name", "n", "", "Name of the API to be imported")
	ImportAPICmd.Flags().StringVarP(&apiVersion, "version", "s", "", "Version of the API to be imported")
	ImportAPICmd.Flags().StringVarP(&environment, "environment", "e", "", "Environment from the which the API should be imported")
