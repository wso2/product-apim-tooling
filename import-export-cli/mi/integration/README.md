...
example: go test -archive apictl-4.2.4-linux-amd64.tar.gz
...
example: go test -archive apictl-4.2.4-linux-amd64.tar.gz -test.run TestGetConnectors
```
...
example: go test -archive apictl-4.2.4-linux-amd64.tar.gz -test.v
```
...
example: go test -archive apictl-4.2.4-linux-amd64.tar.gz -logtransport
```
