...
const proxyServiceCmd = "proxy-services"

func TestGetProxyServices(t *testing.T) {
	testutils.ValidateProxyServiceList(t, proxyServiceCmd, config)
}

func TestGetProxyServiceByName(t *testing.T) {
	testutils.ValidateProxyService(t, proxyServiceCmd, config, validProxyServiceName)
}

func TestGetNonExistingProxyServiceByName(t *testing.T) {
	response, _ := testutils.GetArtifact(t, proxyServiceCmd, invalidProxyServiceName, config)
	base.Log(response)
...
func TestGetProxyServicesWithoutSettingUpEnv(t *testing.T) {
	testutils.ExecGetCommandWithoutSettingEnv(t, proxyServiceCmd)
}

func TestGetProxyServicesWithoutLogin(t *testing.T) {
	testutils.ExecGetCommandWithoutLogin(t, proxyServiceCmd, config)
}

func TestGetProxyServicesWithoutEnvFlag(t *testing.T) {
	testutils.ExecGetCommandWithoutEnvFlag(t, proxyServiceCmd, config)
}

func TestGetProxyServicesWithInvalidArgs(t *testing.T) {
	testutils.ExecGetCommandWithInvalidArgCount(t, config, 1, 2, false, proxyServiceCmd, validProxyServiceName, invalidProxyServiceName)
}
