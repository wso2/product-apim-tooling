...
var HttpRegistry = &Registry{
	...
	Run: func() {
		k8sUtils.K8sCreateSecretFromInputs(k8sUtils.DockerRegCredSecret, k8sUtils.ApiOpWso2Namespace, getRegistryUrl(httpValues.repository), httpValues.username, httpValues.password)
