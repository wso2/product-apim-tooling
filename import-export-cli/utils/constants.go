...
const defaultApiApplicationImportExportSuffix = "api/am/admin/v5"
const defaultPublisherApiImportExportSuffix = "api/am/publisher/v5"
const defaultApiListEndpointSuffix = "api/am/publisher/v5/apis"
const defaultAPIPolicyListEndpointSuffix = "api/am/publisher/v5/operation-policies"
const defaultApiProductListEndpointSuffix = "api/am/publisher/v5/api-products"
const defaultUnifiedSearchEndpointSuffix = "api/am/publisher/v5/search"
const defaultAdminApplicationListEndpointSuffix = "api/am/admin/v5/applications"
const defaultDevPortalApplicationListEndpointSuffix = "api/am/devportal/v4/applications"
const defaultDevPortalThrottlingPoliciesEndpointSuffix = "api/am/devportal/v4/throttling-policies"
