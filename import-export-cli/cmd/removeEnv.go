...
var removeEnvCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println(utils.LogPrefixInfo + "remove-env called")
	},
}
...
func init() {
	...
	// removeEnvCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// removeEnvCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
