...
_apictl_mi_secret_create()
{
    last_command="apictl_mi_secret_create"
...
_apictl_mi_secret_help()
{
    last_command="apictl_mi_secret_help"
...
_apictl_mi_secret_init()
{
    last_command="apictl_mi_secret_init"
