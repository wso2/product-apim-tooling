...
const DevFirstDefaultMCPServerName = "DefaultMCPServer"
const DevFirstDefaultMCPServerVersion = "1.0.0"
const APIYamlFilePath = "api.yaml"
const MCPServerYamlFilePath = "mcp_server.yaml"
const DeploymentEnvYamlFilePath = "deployment_environments.yaml"
const SampleAPIYamlFilePath = "testdata/sample-api.yaml"
const SampleAIAPIDefinitionYamlFilePath = "testdata/sample-ai-api-definition.yaml"
const DevFirstAIAPIName = "OpenAIAPI"
const SampleMCPServerYamlFilePath = "testdata/sample-mcp-server.yaml"
