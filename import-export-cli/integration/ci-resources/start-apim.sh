...
if [ -z "$DOWNLOAD_LINK" ]
then 
    APIM_DOWNLOAD='https://wso2.org/jenkins/job/products/job/product-apim/lastStableBuild/org.wso2.am$wso2am/artifact/org.wso2.am/wso2am/4.2.0-SNAPSHOT/wso2am-4.2.0-SNAPSHOT.zip'
else
...
if [ -z "$NAME" ]
then 
    APIM_PACK=wso2am-4.2.0-SNAPSHOT
else
    APIM_PACK=$NAME
fi
