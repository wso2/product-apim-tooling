...
example: go test -p 1 -timeout 0 -archive apictl-3.2.8-linux-x64.tar.gz
...
example: go test -p 1 -timeout 0 -archive apictl-3.2.8-linux-x64.tar.gz -run TestVersion
```
...
example: go test -p 1 -timeout 0 -archive apictl-3.2.8-linux-x64.tar.gz -v
```
...
example: go test -p 1 -timeout 0 -archive apictl-3.2.8-linux-x64.tar.gz -logtransport
```
