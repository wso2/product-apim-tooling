...
- ### Building
    ...
    Execute `./build.sh -t apictl.go -v 4.5.1 -f` to build for all platforms.
...
- ### Building a Docker Image of APICTL
    ...
    Example: `docker build --build-arg version=4.5.1.1 -t apictl:4.5.1.1 .`

    - ### Using the Docker Image

        `docker run -it -v $(pwd):/git -v ~/.wso2apictl:/root/.wso2apictl -v ~/.wso2apictl.local:/root/.wso2apictl.local apictl:4.5.1.1 <apictl command>`
